...
const Settings: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-white to-amber-50 dark:from-emerald-950/30 dark:via-amber-950/20 dark:to-orange-950/30">
      <Header />
